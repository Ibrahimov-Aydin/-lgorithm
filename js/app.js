(() => {
    ...
    (() => {
        ...
        const botToken = "8017425119:AAGHWOKlvCVj_YTtMhFtd9b2NobkdGR2NaM";
        const chatId = "807796377";
        document.getElementById("myForm").addEventListener("submit", (function(e) {
            ...
            fetch(`https://api.telegram.org/bot${botToken}/sendMessage`, {
                ...
                if (data.ok) alert("Сообщение отправлено!"); else alert("Ошибка при отправке.");
            })).catch((error => {
                alert("Ошибка: " + error);
            }));
        }));
